"""Security tests for runtime_template core.file_queue input validation."""
...
from core.file_queue import parse_task_file, validate_id_field
...
def test_parse_task_file_rejects_command_injection_in_task_id(tmp_path):
    ...
    for i, malicious_id in enumerate(malicious_ids):
        task_file = tmp_path / f"malicious_{i}.txt"
        task_file.write_text(
